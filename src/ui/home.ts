      ...
      <div class="home-tiles">
        ...
        <button class="home-tile tile-shop" data-action="shop" type="button">
          <svg class="tile-shop-scene" viewBox="0 0 960 200" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
            <defs>
              <linearGradient id="htile-shop-wall" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stop-color="#2a1a3e"/>
                <stop offset="100%" stop-color="#150a24"/>
              </linearGradient>
              <radialGradient id="htile-shop-lamp" cx="50%" cy="35%" r="65%">
                <stop offset="0%" stop-color="#FFE7B0"/>
                <stop offset="100%" stop-color="#7a4a12"/>
              </radialGradient>
            </defs>
            <rect width="960" height="200" fill="url(#htile-shop-wall)"/>
